        ...
        {countryInfo.length === 0 ? (
          ...
          <>
            ...
            <article className="mt-12 md:flex md:gap-16">
              ...
              <div>
                <h1 className="font-extrabold mt-8 md:text-xl">
                ...
                <div className="mt-4 md:flex gap-8 md:text-xs">
                  <div className="mb-8 md:mb-2">
                    <p className="font-extrabold text-sm mb-2">
                      ...
                      <span className="font-light">
                        {
                          Object.values(countryInfo[0].name.nativeName)[
                            Object.values(countryInfo[0].name.nativeName)
                              .length - 1
                          ].common
                        }
                  ...
                  <div>
                    <p className="font-extrabold text-sm mb-2">
                      Top Level Domain:{' '}
                      <span className="font-light">{countryInfo[0].tld}</span>
                    </p>
                    <p className="font-extrabold text-sm mb-2">
                      Currencies:{' '}
                      <span className="font-light">
                    ...
                    <p className="font-extrabold text-sm mb-2 flex gap-1">
                      Languages:{' '}
                      ...
                      countryInfo[0].borders.map((border, index) => (
                        <Link key={index} href={`/${border}`}>
                          <button
                            key={index}
                            type="button"
                            className="shadow-customShadow border-white rounded-sm dark:bg-darkElem py-2 px-4 hover:text-gray-500 hover:scale-105"
                          >
                            {border}
                          </button>
                        </Link>
